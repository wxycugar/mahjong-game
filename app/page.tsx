...
export default function MahjongGame() {
  ...
  before:fixed before:inset-0 before:z-0 before:bg-[url('/bg.webp')] before:bg-cover before:bg-center before:bg-no-repeat before:opacity-35 before:pointer-events-none
  after:fixed after:inset-0 after:z-[1] after:bg-gradient-to-b after:from-[#040608]/60 after:via-[#040608]/50 after:to-[#040608]/60 after:pointer-events-none">
