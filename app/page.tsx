...
export default function MahjongGame() {
  ...
  return (
    <main className="min-h-screen bg-[#040608] text-white flex flex-col items-center py-4 px-2 font-sans select-none overflow-hidden relative w-full max-w-[100vw] overflow-x-hidden">
      <GameHeader
        statusLog={statusLog}
        deckSize={deckSize}
        handSize={handSize}
